...
class Entsoe:
    ...
    def __init__(self, api_key, session=None, retry_count=20, retry_delay=3,
                 proxies=None):
        """
        Parameters
        ----------
    ...
    def query_load(self, country_code, start, end, as_series=False, lookup_bzones=False):
        """
        Parameters
        ----------
        country_code : str
